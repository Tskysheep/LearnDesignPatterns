...
sidebar_position: 2
title: 源代码
description: Prototype 模式的完整实现代码
---
...
```cpp title="Prototype.h" showLineNumbers
#pragma once
#include <string>
#include <memory>
...
```cpp title="Prototype.cpp" showLineNumbers
#include "Prototype.h"
#include <iostream>
#include <iomanip>
#include <stdexcept>
...
add_executable(Pattern_Prototype Prototype.cpp Prototype.h)
target_compile_features(Pattern_Prototype PRIVATE cxx_std_17)
```

:::tip 编译运行
```bash
cd build
cmake --build . --target Pattern_Prototype
./Pattern_Prototype
```
:::
